    ...
    public CadAlunos() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout
                        ...
                        .addGroup(layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(btnNovoRegistro).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(layout.createSequentialGroup().addGroup(layout
                                ...
                                .addGroup(layout.createSequentialGroup().addComponent(lblNome)
                                        ...
                                        .addComponent(txtNome, GroupLayout.PREFERRED_SIZE, 157,
                                                GroupLayout.PREFERRED_SIZE))
                                .addGroup(GroupLayout.Alignment.LEADING,
                                        layout.createSequentialGroup().addComponent(lblMatricula)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(txtMatricula, GroupLayout.PREFERRED_SIZE, 157,
                                                        GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup().addComponent(lblCodigo)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(txtCodigo,
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(lblIdade).addComponent(txtIdade, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(btnNovoRegistro).addComponent(btnGravarRegistro).addComponent(btnProximo)
                                .addComponent(btnAnterior))
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (validarTela() == true) {
                    ...
                    if (qteAlunos <= 3) {
                        ...
                        // gravar
                        Aluno aluno = new Aluno(txtNome.getText(), txtEmail.getText(), (Integer) txtIdade.getValue(),
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Atenção!\nOcorreu um erro ao buscar" + " dados de alunos(prx): " + ex.getMessage());
                }
            }
        });
        ...
        btnAnterior.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    limparTela();
                    JOptionPane.showMessageDialog(null,
                            "Atenção!\nOcorreu um erro ao buscar" + " dados de alunos(ant): " + ex.getMessage());
                }
            }
        });
        ...
        btnNovoRegistro.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Erro ao verificar se " + "aluno é de maior: " + ex.getMessage());
                }
            }
        });
